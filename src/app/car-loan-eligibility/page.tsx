...
import { CheckCircle2, User, Phone, Briefcase, IndianRupee, Landmark, Car, ArrowLeft, Loader2, BadgeCheck } from "lucide-react";
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-slate-50 border border-slate-200 focus:border-[#EB0A1E] focus:ring-1 focus:ring-[#EB0A1E] focus:bg-white rounded-xl pl-10 pr-4 py-2.5 text-sm text-slate-900 focus:outline-none transition-all duration-150 disabled:opacity-70 disabled:bg-slate-100"
                />
                {isPhoneVerified && (
            ...
            >
              {isSubmitting ? (
                ...
                "Instant Finance Sanction"
              ) : (
                "Verify Mobile & Sanction"
              )}
            </button>
          </form>
        </div>
