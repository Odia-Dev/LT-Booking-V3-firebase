...
const VEHICLES = [
  { slug: "toyota-glanza", name: "Toyota Glanza", price: "₹6.81 Lakh", booking: "₹11,000", image: "https://images.unsplash.com/photo-1549399542-7e3f8b79c341?auto=format&fit=crop&q=80&w=600", desc: "Advanced smart hatchback with modern features, high mileage, and Toyota's signature reliability." }
];

export default function HatchbackCategoryPage() {
  return (
      ...
      <div className="max-w-7xl mx-auto space-y-10">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <h1 className="text-4xl font-black text-slate-900 tracking-tight">Toyota Hatchback Lineup</h1>
            <p className="text-slate-500 text-sm max-w-2xl leading-relaxed">
              Perfect for city commutes and narrow roads. Discover fuel-efficient hatchback models built for smart connectivity and everyday comfort.
            </p>
          </div>
        </div>
