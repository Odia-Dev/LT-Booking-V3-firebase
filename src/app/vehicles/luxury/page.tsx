...
const VEHICLES = [
  { slug: "toyota-innova-crysta", name: "Toyota Innova Crysta", price: "₹19.99 Lakh", booking: "₹50,000", image: "https://images.unsplash.com/photo-1605559424843-9e4c228bf1c2?auto=format&fit=crop&q=80&w=600", desc: "The legendary luxury MPV built with an ultra-reliable diesel engine, captain seats, and dynamic road presence." },
  { slug: "toyota-vellfire", name: "Toyota Vellfire Hybrid", price: "₹1.20 Crore", booking: "₹2,00,050", image: "https://images.unsplash.com/photo-1517524008436-a3851f153a77?auto=format&fit=crop&q=80&w=600", desc: "Super luxury private lounge on wheels featuring executive heated recliners, advanced climate curtains, and hybrid quietness." },
  { slug: "toyota-landcruiser300", name: "Toyota Land Cruiser 300", price: "₹2.10 Crore", booking: "₹20,00,000", image: "https://images.unsplash.com/photo-1532581291347-9c39cf10a73c?auto=format&fit=crop&q=80&w=600", desc: "The absolute pinnacle of luxury off-roading, powered by a master V6 engine and premium leather interiors." }
];
      ...
      <div className="max-w-7xl mx-auto space-y-10">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <h1 className="text-4xl font-black text-slate-900 tracking-tight">Toyota Luxury Lounge</h1>
            <p className="text-slate-500 text-sm max-w-2xl leading-relaxed">
              Travel first-class. Discover our flagship range of ultra-premium utility vehicles and multi-purpose lounges engineered for maximum comfort.
            </p>
          </div>
        </div>
