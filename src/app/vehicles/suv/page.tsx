...
import { ArrowLeft, Car, Sparkles, ShieldCheck } from "lucide-react";

const VEHICLES = [
  { slug: "toyota-urban-cruiser-taisor", name: "Toyota Taisor", price: "₹7.74 Lakh", booking: "₹11,000", image: "https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?auto=format&fit=crop&q=80&w=600", desc: "Compact SUV built for urban agility and bold statements." },
  { slug: "toyota-urban-cruiser-hyryder", name: "Urban Cruiser Hyryder", price: "₹11.14 Lakh", booking: "₹25,000", image: "https://images.unsplash.com/photo-1511919884226-fd3cad34687c?auto=format&fit=crop&q=80&w=800", desc: "Self-charging hybrid electric SUV with legendary mileage." },
  { slug: "toyota-fortuner", name: "Toyota Fortuner", price: "₹33.43 Lakh", booking: "₹1,00,000", image: "https://images.unsplash.com/photo-1532581291347-9c39cf10a73c?auto=format&fit=crop&q=80&w=600", desc: "The unrivaled leader of the luxury off-road segment." },
  { slug: "toyota-fortuner-legender", name: "Toyota Fortuner Legender", price: "₹43.66 Lakh", booking: "₹1,00,000", image: "https://images.unsplash.com/photo-1532581291347-9c39cf10a73c?auto=format&fit=crop&q=80&w=600", desc: "Ultimate flagship sporty SUV with distinct style elements." },
  { slug: "toyota-hilux", name: "Toyota Hilux", price: "₹30.40 Lakh", booking: "₹1,00,000", image: "https://images.unsplash.com/photo-1541899481282-d53bffe3c35d?auto=format&fit=crop&q=80&w=600", desc: "Heavy-duty lifestyle utility vehicle ready for anything." }
];
      ...
      <div className="max-w-7xl mx-auto space-y-10">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <h1 className="text-4xl font-black text-slate-900 tracking-tight">Toyota SUV Lineup</h1>
            <p className="text-slate-500 text-sm max-w-2xl leading-relaxed">
              Explore our range of premium, rough-and-tough, and hybrid Toyota SUVs designed for extreme safety, comfort, and performance on the roads of Odisha.
            </p>
          </div>
        </div>
