...
const VEHICLES = [
  { slug: "toyota-camry", name: "Toyota Camry Hybrid", price: "₹46.17 Lakh", booking: "₹1,00,000", image: "https://images.unsplash.com/photo-1503376710915-18861d9a2638?auto=format&fit=crop&q=80&w=600", desc: "Premium executive sedan offering dynamic self-charging hybrid power and ultimate back-seat luxury." }
];
      ...
      <div className="max-w-7xl mx-auto space-y-10">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <h1 className="text-4xl font-black text-slate-900 tracking-tight">Toyota Sedan Lineup</h1>
            <p className="text-slate-500 text-sm max-w-2xl leading-relaxed">
              Experience the pinnacle of luxury, silent cabins, and executive comfort with our premium sedan models.
            </p>
          </div>
        </div>
