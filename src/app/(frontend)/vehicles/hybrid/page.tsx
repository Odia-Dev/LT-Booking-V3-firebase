...
const VEHICLES = [
  { slug: "toyota-rumion", name: "Toyota Rumion Hybrid", price: "₹10.44 Lakh", booking: "₹21,000", image: "https://images.unsplash.com/photo-1503376780353-7e6692767b70?auto=format&fit=crop&q=80&w=600", desc: "Spacious MPV featuring smart-hybrid engine technologies for high mileage and reduced carbon emissions." },
  { slug: "toyota-urban-cruiser-hyryder", name: "Urban Cruiser Hyryder Hybrid", price: "₹11.14 Lakh", booking: "₹25,000", image: "https://images.unsplash.com/photo-1511919884226-fd3cad34687c?auto=format&fit=crop&q=80&w=800", desc: "Self-charging hybrid electric SUV with exceptional mileage of up to 27.97 km/l." },
  { slug: "toyota-innova-hycross", name: "Innova Hycross Hybrid", price: "₹18.86 Lakh", booking: "₹50,000", image: "https://images.unsplash.com/photo-1605559424843-9e4c228bf1c2?auto=format&fit=crop&q=80&w=1200", desc: "Premium hybrid utility MPV delivering absolute comfort and smart drive modes." },
  { slug: "toyota-camry", name: "Toyota Camry Hybrid", price: "₹46.17 Lakh", booking: "₹1,00,000", image: "https://images.unsplash.com/photo-1503376710915-18861d9a2638?auto=format&fit=crop&q=80&w=600", desc: "Luxury self-charging hybrid sedan with quiet, effortless performance." }
];
      ...
      <div className="max-w-7xl mx-auto space-y-10">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <h1 className="text-4xl font-black text-slate-900 tracking-tight">Toyota Hybrid Lineup</h1>
            <p className="text-slate-500 text-sm max-w-2xl leading-relaxed">
              Leading the green transition in South Odisha. Experience silent startups, immediate torque, and industry-best fuel savings without range anxiety.
            </p>
          </div>
        </div>
